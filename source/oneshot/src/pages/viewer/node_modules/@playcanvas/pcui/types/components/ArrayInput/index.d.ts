...
import Element, { ElementArgs, IBindable, IBindableArgs, IFocusable } from '@playcanvas/pcui/types/components/Element';
import Container from '@playcanvas/pcui/types/components/Container';
import NumericInput from '@playcanvas/pcui/types/components/NumericInput';
/**
...
declare class ArrayInput extends Element implements IFocusable, IBindable {
    ...
    set binding(value: import("@playcanvas/pcui").BindingBase);
    get binding(): import("@playcanvas/pcui").BindingBase;
    set value(value: any);
    get value(): any;
